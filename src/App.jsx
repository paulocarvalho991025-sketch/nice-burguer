...
>
  ...
  <option value="Nova Descoberta">Nova Descoberta - R$ 6,00</option>
  <option value="Lagoa Nova">Lagoa Nova - R$ 8,00</option>
  <option value="Tirol">Tirol - R$ 10,00</option>
  <option value="Petrópolis">Petrópolis - R$ 10,00</option>
</select>
